...
public class WNPRC_EHRTest extends AbstractGenericEHRTest implements PostgresOnlyTest
{
    ...
    protected static final File STUDY_ZIP = TestFileUtils.getSampleData("wnprc_ehr/EHR Study Anon.zip");
    ...
    {
        beginAt(WebTestHelper.buildURL("wnprc_ehr", getContainerPath(), "wnprcPopulateInitialData"));
