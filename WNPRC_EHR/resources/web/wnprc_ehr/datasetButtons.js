        ...
        batchCompleteRecords: function (dataRegionName) {
            ...
            LABKEY.Query.selectRows({
                ...
                success: function (d) {
                    ...
                    var assay_llod;
                    LABKEY.Query.selectRows({
                        schemaName: 'Viral_Load_Assay',
                        queryName: 'Assays',
                        filterArray: [LABKEY.Filter.create('assayname', toUpdate[0]["assay"], LABKEY.Filter.Types.CONTAINS)],
                        success: function (a) {
                            assay_llod = a["rows"][0]["llod"];
                            new Ext4.Window({
                                title: 'Change Request Status',
                                width: 430,
                                autoHeight: true,
                                ...
                                buttons: [{
                                    ...
                                    handler: function(o) {
                                        ...
                                        var assay_llod = form.getForm().findField('enter-llod').getValue();
                                ...
                                document.getElementById('enter-llod-inputEl').value = assay_llod
                            }, this);
